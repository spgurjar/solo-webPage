...
import prPic1 from "./sidebarComps/proPic1.png";
...
export const SbChild = () => {
    ...
    return(
        <div className="sbChildBody">
            <div className='searchBody'>
               <div className="sIcon"><CiSearch/></div> 
               <input
               type="search"
            ...
            <div><SbCreator profilePic={prPic1} crName="Ethina Cadlin" Seen="a week ago" crDate="11/12/2023" /></div>
